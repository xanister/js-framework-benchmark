...
export let frameworks = [
    ...
    f("polymer-v1.9.3-non-keyed", false, {uri: "polymer-v1.9.3-non-keyed/build/es6-bundled", useShadowRoot: true}),
    f("polymer-v1.9.3-non-keyed-es5", false, {uri: "polymer-v1.9.3-non-keyed/build/es5-bundled", useShadowRoot: true}),
    f("polymer-v2.0.0-non-keyed", false, {uri: "polymer-v2.0.0-non-keyed/build/es6-bundled", useShadowRoot: true}),
    f("polymer-v2.3.1-non-keyed", false, {uri: "polymer-v2.3.1-non-keyed/build/es6-bundled", useShadowRoot: true}),
    f("polymer-v2.3.1-non-keyed-es5", false, {uri: "polymer-v2.3.1-non-keyed/build/es3-bundled", useShadowRoot: true}),
